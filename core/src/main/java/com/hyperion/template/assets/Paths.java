...
public class Paths {
    ...
    // FONT
    public static final String FONT = "font/patrick_hand_64.fnt";

    // TEXTURES
    public static final String MENU_BACKGROUND = "texture/menu_background.png";
    ...
    public static final String GAME_OVER = "sound/game_over.ogg";
